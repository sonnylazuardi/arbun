...
<div class="container" style="color:black; font-family:'Open Sans'">
	<div class="row">
		<div class="span3 desk" style="border-radius:10px;background-color:white;padding-top:10px">
			<p onmouseover="this.style.background='#cccccc'" onmouseout="this.style.background='white'" style="padding-left:10px;padding-top:10px;height:35px;background-color:rgb(255,255,255)">Profil</p>
		...
		<div class="span8" style="border-radius:10px;background-color:white;padding-left:10px;padding-bottom:10px">
			...
			<table class="table table-striped">
			  <tr>
				  <td style="color:blue"> Check</td>
				  <td style="color:blue"> Judul </td>
				  <td style="color:blue"> Tanggal Upload </td>
				  <td style="color:blue"> Mata Kuliah </td>
				  <td style="color:blue"> Bidang </td>
				  <td style="color:blue"> Link </td>
